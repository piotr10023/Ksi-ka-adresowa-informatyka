...
class PhoneBook(QWidget):
    def __init__(self):
        ...
        self.contacts = []  # Lista słowników z kontaktami
        ...
        # Przycisk zapisu kontaktów (dodaje + zapisuje)
        self.save_button = QPushButton("Zapisz kontakty do książki adresowej")
        form_layout.addWidget(self.save_button)

        # Przycisk wczytywania kontaktów
        self.load_button = QPushButton("Wczytaj kontakty z książki adresowej")
        ...
        self.clear_search_button.clicked.connect(self.load_contacts)  # Wyczyść filtr = wczytaj wszystkie
    ...
    def save_contacts(self):
        # Najpierw dodaj nowy kontakt do listy
        ...
        if all([first_name, last_name, phone, city, street, house_number]):
            ...
            # Zapisz całą listę kontaktów do pliku JSON
            try:
                ...
                self.load_contacts()  # odśwież listę kontaktów
            except IOError:
